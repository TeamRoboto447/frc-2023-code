...
public class FollowTrajectoryOdometry extends SwerveControllerCommand {
  /** Creates a new FollowTrajectory. */
  private final DriveSubsystem driveSubsystem;
  private final Trajectory trajectory;
  private final boolean finalMovement;
  public FollowTrajectoryOdometry(DriveSubsystem dSubsystem, Trajectory traj, Rotation2d rotation, boolean lastMove) {
